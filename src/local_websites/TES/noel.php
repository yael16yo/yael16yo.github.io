...
<?php 
    ...
    <?php require_once('assets/navbar.php');?>
        ...
        <main id="fetevoisin">
            <h1 data-aos="fade-right"><span class="behind-text"></span>- CHANTS DE NOEL -</h1>

            <h6 style="text-align:center;margin-top:60px;margin-bottom:30px;">A tous ceux qui souhaitent partager la bonne nouvelle de Noël,
            <br> l’association propose de se joindre à elle pour chanter Noël au centre de Mulhouse durant la période de l’Avent.
</h6>
<p style="text-align:center;"><a href="#" class="red-text">Scrutez les actualités pour plus d’infos !</a></p>
